...
exports.getProjects = async () => { //TODO xBPx
    ...
    const projects = await Project.find({deleted: null, archived: null, booking: true}, {_id: true, name: true, team: true, bookingBudget: true, K2: true, invoice: true, timingClient: true, timingUpp:true, clip: true, bookingType: true, events: true, work: true, bookingNote: true, kickBack: true, created: true}).lean();
