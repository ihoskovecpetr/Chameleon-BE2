...
async function updateEvent(args, kwargs, details) {
    try {
        ...
        const oldEvent = await db.updateEvent(kwargs.id, kwargs.event, args[0]);
...
async function addEvent(args, kwargs, details) {
    try {
        ...
        await db.addEvent(kwargs.id, kwargs.event, args[0]);
...
async function removeEvent(args, kwargs, details) {
    try {
        ...
        await db.removeEvent(kwargs.id, args[0]);
        const result = {id: kwargs.id, event: kwargs.event};
...
async function splitEvent(args, kwargs, details) {
    try {
        ...
        await db.splitEvent(kwargs.id, kwargs.event, kwargs.id2, kwargs.event2, args[0]);
...
async function joinEvents(args, kwargs, details) {
    try {
        ...
        await db.joinEvents(kwargs.id, kwargs.event, kwargs.id2, args[0]);
...
async function addProject(args, kwargs, details) {
    try {
        ...
        const project = await db.addProject(kwargs.id, kwargs.project, args[0]);
...
async function updateProject(args, kwargs, details) {
    try {
        ...
        const data = await db.updateProject(kwargs.id, kwargs.project, args[0]);
...
async function removeProject(args, kwargs, details) {
    try {
        ...
        await db.removeProject(kwargs.id, args[0]);
...
async function addProjectAndEvent(args, kwargs, details) {
    try {
        ...
        const project = await db.addProject(kwargs.idProject, kwargs.project, args[0]);
        await db.addEvent(kwargs.idEvent, kwargs.event, args[0], true);
...
async function addResource(args, kwargs, details) {
    try {
        ...
        const data = await db.addResource(kwargs.id, kwargs.resource, args[0]);
...
async function updateResource(args, kwargs, details) {
    try {
        ...
        const data = await db.updateResource(kwargs.id, kwargs.resource, args[0]);
...
async function removeResource(args, kwargs, details) {
    try {
        ...
        const data = await db.removeResource(kwargs.id, args[0]);
        const result = {groups: data[0], resources: data[1]};
        wamp.publish('updateData', [], result, {exclude : [details.caller]});
...
async function reorderResource(args, kwargs, details) {
    try {
        ...
        const data = await db.reorderResource(kwargs.id1, kwargs.members1, kwargs.id2, kwargs.members2, kwargs.id3, args[0]);
...
async function addGroup(args, kwargs, details) {
    try {
        ...
        const groups = await db.addGroup(kwargs.id, kwargs.group, args[0]);
...
async function updateGroup(args, kwargs, details) {
    try {
        ...
        const groups = await db.updateGroup(kwargs.id, kwargs.group, args[0]);
        const result = {groups: groups};
        wamp.publish('updateData', [], result, {exclude : [details.caller]});
...
async function removeGroup(args, kwargs, details) {
    try {
        ...
        const groups = await db.removeGroup(kwargs.id, args[0]);
        const result = {groups: groups};
        wamp.publish('updateData', [], result, {exclude : [details.caller]});
...
async function reorderGroups(args, kwargs, details) {
    try {
        ...
        const groups = await db.reorderGroups(kwargs.order, args[0]);
        const result = {groups: groups};
        wamp.publish('updateData', [], result, {exclude: [details.caller]});
...
async function changeUserPin(args, kwargs, details) {
    try {
        ...
        const data = await db.changeUserPin(kwargs.id, kwargs.group, kwargs.pin, args[0]);
